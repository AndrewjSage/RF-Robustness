...
#contaminated
set.seed(02042017)  #Important to keep seed same for all files, so we're dealing with same datasets
Res <- sapply(X=1:5, simplify="array", FUN=function(i){Assess_Real_Data(dataset, nfolds=10, p=0.15, ntrees=1000, ndsize=5, ntreestune=100, parvec=parvec, cvreps=1, cvfolds=9, tol=10^-6 )})
